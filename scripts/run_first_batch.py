...
from mset.first_batch import build_conditions, build_design, iter_run_specs  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the >10,000-run MSET Phase I first batch.")
    parser.add_argument("--base", default="configs/screening/phase1_first_batch_base.json")
    parser.add_argument("--output", default="results/phase1_first_batch")
